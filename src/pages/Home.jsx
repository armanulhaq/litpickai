    ...
    return (
        <div className="relative min-h-screen bg-white overflow-hidden">
            ...
            <div className="absolute inset-0">
                ...
                <div className="absolute bottom-40 left-20 w-24 h-24 bg-purple-100 rounded-full opacity-50"></div>
            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen px-6 pt-20 my-10 md:my-0">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto mb-16">
                        ...
                        <div className="flex items-center justify-center gap-3 p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl border border-amber-100">
                            <Text className="w-6 h-6 text-amber-600" />
                            <span className="text-gray-700 text-sm md:text-md font-medium">
                                More Than a Summary
                            </span>
                        </div>
